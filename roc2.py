...
def agregar_operador():
    ...
    if agregar_operador_modelo(registro, nombre, categoria, direccion, telefono, email, fecha_alta, fecha_baja, situacion, comentarios):
        ...
        messagebox.showerror("Error", "Todos los campos requeridos deben ser intregrados")
...
root.geometry("1200x800")  # Tamaño de la ventana más pequeño que pantalla completa

# Asignar la tecla 'ESC' para salir
root.bind('<Escape>', salir)

# Configurar el diseño de la grilla con 3 columnas
